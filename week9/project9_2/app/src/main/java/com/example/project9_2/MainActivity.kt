...
import com.example.project9_2.databinding.ActivityMainBinding
import java.io.File

class MainActivity : AppCompatActivity() {
    private  var downloadId: Long = -1L
    private lateinit var downloadMananger: DownloadManager
        ...
        override fun onReceive(context: Context, intent: Intent) {
            ...
            if (DownloadManager.ACTION_DOWNLOAD_COMPLETE.equals(intent.action)){
                if (downloadId == id) {
                    ...
                    var cursor = downloadMananger.query(query)
                    ...
                    if(status == DownloadManager.STATUS_SUCCESSFUL){
                        ...
                        Toast.makeText(context, "Download falied", Toast.LENGTH_SHORT).show()
                    }
                }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        downloadMananger = getSystemService(Context.DOWNLOAD_SERVICE) as DownloadManager
        ...
        binding.downloadBtn.setOnClickListener{
            ...
            downloadId = downloadMananger.enqueue(request)
        }
        binding.cancelBtn.setOnClickListener {
            if(downloadId != -1L){
                downloadMananger.remove(downloadId)
            }
        }
